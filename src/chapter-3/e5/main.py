...
class DoublyLinkedList:
    ...
    def remove(self, index):
        ...
        # middle
            ...
            next_node.next.prev = previous_node
        ...
        # Save the content of the node and remove it
        value = next_node.data
        del(next_node)

        # Update size and return the value of the removed node
        self._size -= 1
        return value
...
def main():
    ...
    for i in range(10, 51, 10):
        mylist.append(i)
    val = mylist.remove(2)
    print(val, mylist)  # 30 <DoublyLinkedList (4 elements): [10, 20, 40, 50]>
